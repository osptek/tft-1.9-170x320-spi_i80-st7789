...
<p align="center"><img alt="OSPTEK 1.9 inch 170×320 TFT SPI / I80 module (ST7789) product image" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.9″ 170×320 TFT** is a color display module that switches between **SPI** and **I80**, driven by **ST7789**. IM pins on the same FPC select the interface.

Spec ID (repository name): `tft-1.9-170x320-spi_i80-st7789`

Current module version: **YDP190H001-V2**. Electrical and mechanical details follow [`docs/YDP190H001-V2.pdf`](./docs/YDP190H001-V2.pdf).
...
└── versions/
    └── YDP190H001-V2/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (YDP190H001-V2) | [`docs/YDP190H001-V2.pdf`](./docs/YDP190H001-V2.pdf) |
