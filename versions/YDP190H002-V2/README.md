...
<p align="center"><b>TFT 模组 · SPI / I80 · ST7789</b></p>
...
<p align="center"><img alt="OSPTEK 1.9 寸 170×320 TFT SPI / I80 模组（ST7789）宣传图" src="./images/product.png" width="640" /></p>
...
OSPTEK **1.9 寸 170×320 TFT** 是一款可在 **SPI** 与 **I80** 之间切换的彩色显示模组，驱动为 **ST7789**。适合手持终端、穿戴与小型竖屏 HMI 等场景。同一料号、同一 FPC 通过 IM 脚选择接口。

规格标识（仓库名）：`tft-1.9-170x320-spi_i80-st7789`

当前模组版本：**YDP190H002-V2**。电气与外形细节以 [`docs/YDP190H002-V2.pdf`](./docs/YDP190H002-V2.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP190H002-V2） | [`docs/YDP190H002-V2.pdf`](./docs/YDP190H002-V2.pdf) |
